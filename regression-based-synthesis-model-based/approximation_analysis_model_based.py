...
e_vec_TS_forw = approximation_error_TS(forw_inp_TS_filename, forw_out_TS_c_filename, forw_out_TS_r_filename, e_vec_TS_forw_filename, num_state_inp_pairs, NN_TS_forw, NN_GB_forw, dim_x+dim_u, dim_x)
